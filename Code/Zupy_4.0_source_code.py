...
def start_the_game():
    ...
    global dash_cooldown, current_time, monster2_pos, player_pos, monster_pos
    global time, dt, clock, verif1, verif2, etat, etat_diff, player_speed, etat_speed
    pause = 0
    ...
    while etat == 1:
        ...
        if pause == 0:
            ...
            if player_pos.distance_to(monster_pos) <= 40 or player_pos.distance_to(monster2_pos) <= 40:
                stop_game()
